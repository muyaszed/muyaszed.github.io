 ...
 /**********Data collection and display*************/     
    ...
    $( "form" ).on( "submit", function( event ) {
      ...
      myQuery = $("#search").val();
        ...
        url: "https://en.wikipedia.org/w/api.php?action=query&format=json&list=search&titles=&generator=search&srsearch="+myQuery+"&gsrsearch=" + myQuery + "&gsrlimit=10&callback=?",
